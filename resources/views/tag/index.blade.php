                        ...
                        @foreach($tags as $tag)
                                <li class="list-group-item">
                                    <span style="font-size: 130%;" class="mr-2 badge badge-{{ $tag->style }}">{{ $tag->name }}</span>
                                        ...
                                        <a class="ml-2 btn btn-sm btn-outline-primary" href="/tags/{{ $tag->id }}/edit"><i class="fas fa-edit"></i> Edit</a>
                                        <form style="display: inline;" action="/tags/{{ $tag->id }}" method="post">
                                            @csrf
                                            @method('DELETE')
